...
import styles from "../../../assets/styles/HRDepartments.module.css";
  ...
  const handleAddDepartment = async (e) => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:8080/api/insert-department",
        {
  ...
  const handleEditDepartment = async (e) => {
    ...
    try {
      const response = await axios.put(
        `http://localhost:8080/api/update-department/${selectedDepartment.id}`,
        {
          name: departmentsData.departmentName,
          description: departmentsData.description,
        }
  ...
  const handleDeleteDepartment = async () => {
    ...
    try {
      const response = await axios.delete(
        `http://localhost:8080/api/delete-department/${selectedDepartment.id}`
      );
...
export default HRDepartmentsComponents;
