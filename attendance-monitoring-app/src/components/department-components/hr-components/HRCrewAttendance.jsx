...
import styles from "../../../assets/styles/HRCrewAttendance.module.css";
  ...
  const fetchAttendances = async () => {
    try {
      ...
      if (response.data.success) {
        const crewAttendances = response.data.data.filter(
          (user) => user.role === "Crew"
        );
        setAttendances(crewAttendances);
      }
    } catch (error) {
      console.error("Error fetching crew attendances:", error);
    }
  };
...
export default HRCrewAttendance;
