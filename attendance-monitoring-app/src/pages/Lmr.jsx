...
import styles from "../assets/styles/Lmr.module.css";
import OPSLmr from "../components/department-components/ops-components/OPSLmr";
const API_BASE_URL =
  ...
  return (
    <div className={styles.lmr}>
      ...
      <div className={styles["lmr-container"]}>
        ...
        {userDepartment === "Operations" ? <OPSLmr /> : ""}
      </div>
    </div>
  );
};
